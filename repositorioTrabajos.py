    ...
    def store(self, trabajo):
        ...
        try:
            ...
            if trabajo.fecha_entrega_propuesta == None:
                ...
                parametros.append(trabajo.fecha_entrega_propuesta.strftime("%Y-%m-%d"))

            if trabajo.fecha_entrega_real == None:
                parametros.append(None)
            else:
                parametros.append(trabajo.fecha_entrega_real.strftime("%Y-%m-%d"))
    ...
    def update(self, trabajo):
        ...
        try:
            result = self.cursor.execute(
                consulta, [fi, fep, fer, trabajo.descripcion, r, trabajo.id_trabajo]
            )
