    ...
    def get_one_corporativo(self, id_cliente):
        ...
        if result == None:
            ...
            return ClienteCorporativo(
                result[0], result[1], result[2], result[3], result[4], id_cliente
            )
    ...
    def get_one_particular(self, id_cliente):
        ...
        if result == None:
            ...
            return ClienteParticular(
                result[0], result[1], result[2], result[3], id_cliente
            )
    ...
    def update(self, cliente):
        ...
        try:
            ...
            result = self.cursor.execute(
                consulta, [cliente.telefono, cliente.mail, cliente.id_cliente]
            )
